                ...
                >
                  <div className="p-6 space-y-4">
                    <div className="flex justify-between gap-2 items-start">
                        ...
                        {(blog.tags??[]).map((tag:{tagName:string})=><span className={`px-3 py-1  rounded-full text-sm  bg-[#d4a373]/20 text-[#d4a373] `}>{tag.tagName}</span>)}
                    ...
                    <div className="flex items-center justify-between pt-4">
                      <span className="text-sm text-[#d4a373]">
                        ...
                        <br />
                        <h6 className="text-[#A3A3A3] text-sm">{blog.createdAt.split('T')[0]}</h6>
                      </span>
                      <br />
